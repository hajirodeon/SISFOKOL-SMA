...
$ke = "$filenya?tapelkd=$tapelkd&smtkd=$smtkd&kelkd=$kelkd&page=$page";
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&kelkd='.$btkd.'">'.$btkelas.'</option>';
	}
...
if (empty($tapelkd))
	...
	$target = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&smtkd=$smtkd";
